...
#include "../../../../Source/Runner/Public/Bonus/ScoreMultiplication.h"
...
void AGameModeRunner::UpdatePoint()
{
	/*AScoreMultiplication* ScoreMult;
	float mult = ScoreMult->GetMultiplier();*/
	CurrentPoint += 1.f;// *mult;
}
