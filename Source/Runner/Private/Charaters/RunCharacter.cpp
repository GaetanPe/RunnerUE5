...
void ARunCharacter::CharacterTakeDamage(float DamageAmount)
{
...
void ARunCharacter::Heal(float HealAmount)
{
...
void ARunCharacter::UpdatePoint()
{
	RunGameMode->UpdatePoint();
}
